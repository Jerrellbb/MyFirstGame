...
func _ready():
	...
	initial_tween.tween_property(self,"scale",Vector2(1,1)*attack_size,3).set_trans(Tween.TRANS_QUINT).set_ease(Tween.EASE_OUT)#increase attack size
	...
	if set_angle == 1:
		...
		tween.tween_property(self,"angle", angle_more,1)# reduced tween duration from 2 to 1 for more sudden movement
		tween.tween_property(self,"angle", angle_less,1)
		tween.tween_property(self,"angle", angle_more,1)
		tween.tween_property(self,"angle", angle_less,1)
		tween.tween_property(self,"angle", angle_more,1)
		tween.tween_property(self,"angle", angle_less,1)
