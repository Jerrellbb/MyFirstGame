...
var spr_jav_reg = preload("res://textures/Items/javelin_3_new.png")
var spr_jav_atk = preload("res://textures/Items/javelin_3_new_attack.png")
...
func add_paths():
	snd_attack.play()#added audio files
...
func enable_attack(atk = true): #flip between attackong and idle with textures included
	if atk:
...
func _on_reset_pos_timer_timeout():
	var choose_direction = randi() % 4 #randi random integer out of 4
